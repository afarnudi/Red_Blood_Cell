...
using namespace std;
//-----------------------HEADERS
void Membrane_Force_Calculator (double Membrane_Node_Position[Membrane_num_of_Nodes][3],double Membrane_Node_Velocity[Membrane_num_of_Nodes][3],double Membrane_Node_Force [Membrane_num_of_Nodes][3],int Membrane_Node_Pair_list[][2], vector<vector<int> > Membrane_Triangle_Pair_Node,double &Total_Potential_Energy, int Membrane_num_of_Triangle_Pairs, int Membrane_num_of_Node_Pairs);// updates forces + relavant potential energy

int parallelORantiparallel( double xpos[3][5] );// + for parallel  -for anti parallel (used in force cacculator of membrane)

double potentialenergy(double Membrane_Node_Position[Membrane_num_of_Nodes][3],int Membrane_Node_Pair_list[][2],int Membrane_Triangle_Pair_Nodes[][4] ,int Membrane_triangle_list[Membrane_num_of_Triangles][3], int Outer_Membrane_num_of_triangles, int Nucleus_Membrane_num_of_triangles, int Membrane_num_of_Triangle_Pairs, int Membrane_num_of_Node_Pairs);//  potential energy
...
void updatetriangle(int p1, int p2,int p3,int p4 ,int Membrane_triangle_list[Membrane_num_of_Triangles][3],int &l1,int &l2, double  Membrane_Node_Position [Membrane_num_of_Nodes][3], int Membrane_Normal_direction[Membrane_num_of_Triangles][2] );
double periodiccondition(double dx );
double Membrane_surface_area_calculator(double  Membrane_Node_Position [Membrane_num_of_Nodes][3],  int Membrane_triangle_list[Membrane_num_of_Triangles][3], int Outer_Membrane_num_of_triangles);

double surfaceareaNucleus(double  Membrane_Node_Position [Membrane_num_of_Nodes][3],  int Membrane_triangle_list[Membrane_num_of_Triangles][3], int Outer_Membrane_num_of_triangles);
void ConstantSurfaceForceLocalTriangles(double Membrane_Node_Position[Membrane_num_of_Nodes][3],double Membrane_Node_Force[Membrane_num_of_Nodes][3],int Membrane_triangle_list[Membrane_num_of_Triangles][3], int Outer_Membrane_num_of_triangles);

double VolumeNucleus(double Membrane_Node_Position[Membrane_num_of_Nodes][3],int Membrane_triangle_list[Membrane_num_of_Triangles][3],int Membrane_Normal_direction[Membrane_num_of_Triangles][2], int Outer_Membrane_num_of_triangles);

double VolumeMemerane(double Membrane_Node_Position[Membrane_num_of_Nodes][3],int tri[3][Membrane_num_of_Triangles],int Membrane_Normal_direction[Membrane_num_of_Triangles][2], int Outer_Membrane_num_of_triangles);
// ------------------------------membrane
...
void Chromatin_membrane_Barrier(double Chromatin_Bead_Position[Chromatin_num_of_Beads][3], double Chromatin_Bead_Velocity[Chromatin_num_of_Beads][3], double Chromatin_Bead_Force[Chromatin_num_of_Beads][3], double Membrane_Node_Position[Membrane_num_of_Nodes][3], double Membrane_Node_Velocity[Membrane_num_of_Nodes][3], int Membrane_triangle_list[Membrane_num_of_Triangles][3], int Membrane_Normal_direction[Membrane_num_of_Triangles][2], int Outer_Membrane_num_of_triangles);

void Chromatin_membrane_Barrier_2(double Chromatin_Bead_Position[Chromatin_num_of_Beads][3], double Chromatin_Bead_Velocity[Chromatin_num_of_Beads][3], double Chromatin_Bead_Force[Chromatin_num_of_Beads][3], double Membrane_Node_Position[Membrane_num_of_Nodes][3], double Membrane_Node_Velocity[Membrane_num_of_Nodes][3], int Membrane_triangle_list[Membrane_num_of_Triangles][3], int Membrane_Normal_direction[Membrane_num_of_Triangles][2], int Outer_Membrane_num_of_triangles);
...
void Membrane_ECM_interaction(int istep,double Membrane_Node_Position [Membrane_num_of_Nodes][3],double Membrane_Node_Velocity [Membrane_num_of_Nodes][3],double Membrane_Node_Force [Membrane_num_of_Nodes][3], double  ECM_Node_Position [][3],double  ECM_Node_Velocity [][3],double  ECM_Node_Force [][3],int ECM_surface_triangle_list[ECM_Surface_num_of_Triangles][3],int Membrane_triangle_list[Membrane_num_of_Triangles][3],int Membrane_Normal_direction[Membrane_num_of_Triangles][2],  int ECMandmembrane[][ 1+maximumHowmanyECMCouldInteractWithmembrane] ,double Cellcom[3], int Outer_Membrane_num_of_triangles);


void Membrane_ECM_interaction_4(int MD_Step, double Membrane_Node_Position[Membrane_num_of_Nodes][3], double Membrane_Node_Velocity[Membrane_num_of_Nodes][3], double Membrane_Node_Force[Membrane_num_of_Nodes][3], double ECM_Node_Position[][3], double ECM_Node_Velocity[][3], double ECM_Node_Force[][3], int ECM_surface_triangle_list[ECM_Surface_num_of_Triangles][3],int Membrane_triangle_list[Membrane_num_of_Triangles][3], int Membrane_Normal_direction[Membrane_num_of_Triangles][2], vector<vector<int> > &ECM_Membrane_Trinagle_neighbours_2, double Cellcom[3], int Outer_Membrane_num_of_triangles, int  Outer_Membrane_num_of_Nodes, int Outer_Membrane_list_of_Nodes[], vector<int>  &Membrane_Edge_triangle_and_ECM_neighbours, double &Total_Potential_Energy);

void Membrane_ECM_interaction_5(int MD_Step, double Membrane_Node_Position[Membrane_num_of_Nodes][3], double Membrane_Node_Velocity[Membrane_num_of_Nodes][3], double Membrane_Node_Force[Membrane_num_of_Nodes][3], double ECM_Node_Position[][3], double ECM_Node_Velocity[][3], double ECM_Node_Force[][3], int ECM_surface_triangle_list[ECM_Surface_num_of_Triangles][3],int Membrane_triangle_list[Membrane_num_of_Triangles][3], int Membrane_Normal_direction[Membrane_num_of_Triangles][2], vector<int> &ECM_Membrane_Trinagle_neighbours_3, double Cellcom[3], int Outer_Membrane_num_of_triangles, int  Outer_Membrane_num_of_Nodes, int Outer_Membrane_list_of_Nodes[], vector<int>  &Membrane_Edge_triangle_and_ECM_neighbours, double &Total_Potential_Energy);
...
void findcom(double vcom[3][Membrane_num_of_Triangles],double pcom[3][Membrane_num_of_Triangles],int Membrane_triangle_list[Membrane_num_of_Triangles][3], double (&Membrane_Node_Position)[Membrane_num_of_Nodes][3], double (&Membrane_Node_Velocity)[Membrane_num_of_Nodes][3]);
void interaction(double (&Membrane_Node_Position)[Membrane_num_of_Nodes][3], double (&Membrane_Node_Velocity)[Membrane_num_of_Nodes][3], int trianglememebrane[3][Membrane_num_of_Triangles],int Membrane_Normal_direction[Membrane_num_of_Triangles][2]);
...
//-----------------------------thermostat------------------
double kineticenergymembrane (double  Membrane_Node_Velocity [Membrane_num_of_Nodes][3]);
...
void restartsave(double Membrane_Node_Position[Membrane_num_of_Nodes][3], double Membrane_Node_Velocity [Membrane_num_of_Nodes][3], int Membrane_triangle_list[Membrane_num_of_Triangles][3], vector<vector<int> > Membrane_Triangle_Pair_Nodes, int bondslist[][2], double Actin_Node_Position[Actin_num_of_Nodes][3], double Actin_Node_Velocity[Actin_num_of_Nodes][3], double Actin_Node_Pair_List[][3], int Membrane_num_of_Triangle_Pairs, int Actin_num_of_Bonds);


void restartread(double Membrane_Node_Position [Membrane_num_of_Nodes][3], double Membrane_Node_Velocity [Membrane_num_of_Nodes][3], int Membrane_triangle_list[Membrane_num_of_Triangles][3], vector< vector<int> > &Membrane_Triangle_Pair_Nodes, int bondslist[][2], double Actin_Node_Position[Actin_num_of_Nodes][3], double Actin_Node_Velocity[Actin_num_of_Nodes][3],double Actin_Node_Pair_List[][3], int Membrane_num_of_Triangle_Pairs, int Actin_num_of_Bonds);
//---------------------------restart-----------------------
...
int main() //main**
{
    ...
    traj_file_name="results/ECM-Durotaxis-test-";
...
//    int  Membrane_triangle_triangle_neighbour_list[Membrane_num_of_Triangles][3];
    ...
    int Membrane_num_of_Triangle_Pairs=Membrane_triangle_pair_counter( Membrane_triangle_list);
    Membrane_Triangle_Pair_Nodes.resize(Membrane_num_of_Triangle_Pairs);
//    int Membrane_Triangle_Pair_Nodes[Membrane_num_of_Triangle_Pairs][4]; // pos1 pos2 pos3 and po4 of all interactions are stored here; The first two elements are the nodes on the common edge of the two triangle pairs. The third and last elements are on the other sides.
    ...
    Membrane_num_of_Node_Pairs=Membrane_num_of_Node_Pair_Counter(Membrane_triangle_list, Outer_Membrane_num_of_triangles, Outer_Membrane_num_of_Node_Pairs);
...
void Membrane_Force_Calculator (double Membrane_Node_Position[Membrane_num_of_Nodes][3], double Membrane_Node_Velocity[Membrane_num_of_Nodes][3], double Membrane_Node_Force [Membrane_num_of_Nodes][3], int Membrane_Node_Pair_list[][2], vector< vector<int> > Membrane_Triangle_Pair_Nodes, double &Total_Potential_Energy, int Membrane_num_of_Triangle_Pairs, int Membrane_num_of_Node_Pairs)
{
    double le0, le1, lmax, lmin;
    double deltax, deltay, deltaz, temp_Node_distance, temp_force;
    int pos1, pos2, pos3, pos4;  // to make the surface force calculations easier.
...
void Membrane_ECM_interaction(int istep,double Membrane_Node_Position [Membrane_num_of_Nodes][3],double Membrane_Node_Velocity [Membrane_num_of_Nodes][3],double Membrane_Node_Force [Membrane_num_of_Nodes][3]                        ,double  ECM_Node_Position [][3],double  ECM_Node_Velocity [][3],double  ECM_Node_Force [][3],int ECM_surface_triangle_list[ECM_Surface_num_of_Triangles][3],int Membrane_triangle_list[Membrane_num_of_Triangles][3],int Membrane_Normal_direction[Membrane_num_of_Triangles][2],  int ECMandmembrane[][ 1+maximumHowmanyECMCouldInteractWithmembrane] ,double Cellcom[3], int Outer_Membrane_num_of_triangles)
{
    ...
    double Migrating___force_Vec[3][Membrane_num_of_Nodes]={0};
...
void cellshift( double  Membrane_Node_Position [Membrane_num_of_Nodes][3],double Actin_Node_Position[Actin_num_of_Nodes][3],double  Membrane_Node_Velocity [Membrane_num_of_Nodes][3],double Actin_Node_Velocity[Actin_num_of_Nodes][3])
{
    ...
    {
        Actin_Node_Position[i][0] += membraneshiftinXdirection;
        Actin_Node_Position[i][2] += membraneshiftinZdirection;
    }
    ...
    for (int i=0; i<Actin_num_of_Nodes ; i++)
    {
        Actin_Node_Velocity[i][1] += cell_downward_speed;
...
void CellCOM( double com[3],double  Membrane_Node_Position [Membrane_num_of_Nodes][3],double  Actin_Node_Position [][3])
{
     ...
     */
    //*******************************************************************************************************
    //***************** The Actin-membrane shared nodes are not included in the COM calculations. I think they should be included since they carry mass, and especialy now since they are conected with a spring. The cell does not seem to hold when I changed it, so for the mean time I'm keeping it the same way it was.*****************************
    //*******************************************************************************************************
...
void interaction(double (&Membrane_Node_Position)[Membrane_num_of_Nodes][3], double (&Membrane_Node_Velocity)[Membrane_num_of_Nodes][3], int Membrane_triangle_list[Membrane_num_of_Triangles][3], int Membrane_Normal_direction[Membrane_num_of_Triangles][2])
{
